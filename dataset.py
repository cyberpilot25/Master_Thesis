...
dobs = [(today - timedelta(days=365.25 * age)).date() for age in ages]  # Remove time from DOB
...
conditions = [
  ...
  'Heart Disease', 'Cancer', 'Flu', 'Pneumonia', 'Osteoporosis', 'GERD', 'Migraine', 'COVID-19', 'Stroke',
  'Alzheimer\'s Disease', 'Parkinson\'s Disease', 'Chronic Kidney Disease', 'Liver Cirrhosis', 'Tuberculosis',
  'HIV/AIDS', 'Multiple Sclerosis', 'Epilepsy'
]

# Adjusted probabilities to ensure they are non-negative and sum to 1
condition_probabilities = [
  0.10, 0.09, 0.08, 0.07, 0.07, 0.06, 0.06, 0.05, 0.05, 0.04, 0.04, 0.03, 0.03, 0.04, 0.04, 0.03, 0.02,
...
# Generate ailments
ailments = np.random.choice(conditions, size=num_patients, p=condition_probabilities)
...
treatment_map = {
  ...
  'Cancer': ['Surgery', 'Chemotherapy', 'Radiation Therapy', 'Biopsy'],
...
ailment_to_complaint = {
  ...
  'High Cholesterol': ['No symptoms', 'Chest pain (mild to severe)', 'Shortness of breath (mild to severe)', 'None'],
  ...
  'Cancer': ['Unexplained weight loss', 'Fatigue', 'Persistent pain', 'Skin changes'],
...
ailment_to_medication = {
  ...
  'Cancer': ['Chemotherapy regimen (varies)', 'Chemotherapy regimen (varies)', 'Chemotherapy regimen (varies)'],
...
print("Data stored to patient_data.csv")